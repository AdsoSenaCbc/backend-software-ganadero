...
class VacunacionAnimal(db.Model):
    ...
    id_vacuna = db.Column(db.Integer, db.ForeignKey('vacuna.id_vacuna'), primary_key=True)
    id_lote = db.Column(db.Integer, db.ForeignKey('lote_vacuna.id_lote'), nullable=True)
    fecha_aplicacion = db.Column(db.DateTime, primary_key=True, default=db.func.current_timestamp())
